...
# Pack tuning. The per-chunk *uncompressed* block MUST stay <= the console's
# fixed decompression buffer (0x8000); larger blocks overflow it and freeze.
UNCOMPRESSED_BLOCK = 0x8000
